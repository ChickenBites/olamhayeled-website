...
echo שלב 1: מיסוך פנים בתמונות חדשות...
python blur_new_images.py
if %errorlevel% neq 0 (
    echo שגיאה במיסוך תמונות
    echo ודא שיש לך Python ו-OpenCV מותקנים
    pause
    exit /b 1
)

echo.
echo שלב 2: מוסיף תמונות ל-Git...
git add .
if %errorlevel% neq 0 (
